...
public class App 
{
    public static void main( String[] args )
    {
         ...
         */
        ApplicationContext context = new ClassPathXmlApplicationContext("beens.xml"); // using XML-based configuration
...
//		Dev obj = new Dev();
        ...
        /*
         * below code, we used another IOC Container generated by Java-based configuration
         * here, AppConfig.class is a configuration class present in the com.learning
         */
        ApplicationContext context2 = new AnnotationConfigApplicationContext(AppConfig.class); // using Java-based configuration
        Dev dev = (Dev) context2.getBean("dev");
